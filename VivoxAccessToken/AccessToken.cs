...
{   /// <summary>
    ...
    public class AccessToken
    {
        ...
        /// 
        ///
        public static string Token_f(string key, string issuer, int exp, string vxa, int vxi, string sub, string f, string t)
        {
        ...
        /// <value>Holds Unix Epoch (January 1st, 1970, 00:00:00) - Used in <see cref="SecondsSinceUnixEpochPlusDuration(TimeSpan?)"></see></value>
        ...
        /// see <see cref="AccessToken.Token_f(string, string, int, string, int, string, string, string)"/> see epoch time.
